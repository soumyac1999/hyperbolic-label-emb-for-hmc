# Based on https://github.com/morningmoni/HiLAP/blob/master/readData_rcv1.py
...
def read_rcv1():
    ...
    with open('rcv1/rcv1.topics.hier.orig') as f:
        for line in f:
    ...
    train_ids = []
    test_ids = []
    train_id_set = read_rcv1_ids('rcv1/lyrl2004_tokens_train.dat')
    test_id_set = read_rcv1_ids('rcv1/lyrl2004_tokens_test_pt0.dat')
    test_id_set |= read_rcv1_ids('rcv1/lyrl2004_tokens_test_pt1.dat')
    test_id_set |= read_rcv1_ids('rcv1/lyrl2004_tokens_test_pt2.dat')
    test_id_set |= read_rcv1_ids('rcv1/lyrl2004_tokens_test_pt3.dat')
